...
function vw_eco_nature_activation_notice() {
	...
	echo '<h3>'. esc_html__( 'Warm Greetings to you!!', 'vw-eco-nature' ) .'</h3>';
	...
	echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=vw_eco_nature_guide' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'vw-eco-nature' ) .'</a></p>';
	echo '</div>';
}
...
function vw_eco_nature_scripts() {
	...
	wp_enqueue_script( 'vw-eco-nature-custom-scripts-jquery', get_template_directory_uri() . '/assets/js/custom.js', array('jquery') );
...
/* admin bar */
function vw_eco_nature_my_filter_head(){
	remove_action('wp_head','_admin_bar_bump_cb');
}
add_action('get_header','vw_eco_nature_my_filter_head');
...
if ( ! function_exists( 'vw_eco_nature_credit' ) ) {
	function vw_eco_nature_credit(){
		echo "<a href=".esc_url(VW_ECO_NATURE_CREDIT).">".esc_html__('Eco Nature WordPress Theme','vw-eco-nature')."</a>";
	}
}
