...
class VW_Eco_Nature_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'VW_Eco_Nature_About_Widget',
			__('VW About us', 'vw-eco-nature'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'vw-eco-nature' ), ) 
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		<div class="widget">
	        ...
	        <?php if(!empty($read_more_url) ){ ?><div class="more-button"><a class="custom_read_more" href="<?php echo esc_url($instance['read_more_url']); ?>"><i class="fas fa-plus"></i><?php if(!empty($read_more_text) ){ ?><?php echo esc_html($instance['read_more_text']); ?><?php } ?><i class="fas fa-angle-right"></i></a></div><?php } ?>	        
	        <?php echo '</div>';
			?>
		</div>
		<?php
	...
	public function form( $instance ) {
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','vw-eco-nature'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','vw-eco-nature'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','vw-eco-nature'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','vw-eco-nature'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','vw-eco-nature'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','vw-eco-nature'); ?></label>
		<?php
...
function vw_eco_nature_about_custom_load_widget() {
	register_widget( 'VW_Eco_Nature_About_Widget' );
}
add_action( 'widgets_init', 'vw_eco_nature_about_custom_load_widget' );